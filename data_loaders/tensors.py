...
def truebones_collate(batch):
    ...
    if 'kinematic_chains' in notnone_batches[0]:
        kinematic_chainsbatch = [b['kinematic_chains'] for b in notnone_batches]
        cond['y'].update({'kinematic_chains': kinematic_chainsbatch})
...
""" recieves list of tuples of the form: 
 motion, m_length, parents, tpos_first_frame, offsets, self.temporal_mask_template, joints_graph_dist, joints_relations, object_type, joints_names_embs, ind, mean, std, kinematic_chains, max_joints 
"""
